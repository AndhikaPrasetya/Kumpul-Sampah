        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/assets/images/flags/us.jpg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/assets/images/flags/spain.jpg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/assets/images/flags/germany.jpg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template/assets/images/flags/italy.jpg")
                : "ru" == e &&
                  (document.getElementById("header-lang-img").src =
                      "/template/assets/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && n(a),
            s.getJSON("/template/assets/lang/" + t + ".json", function (e) {
                s("html").attr("lang", t),
    ...
    function c(e) {
        ...
        "light-mode-switch" === e
            ? (s("html").removeAttr("dir"),
              ...
              "/template/assets/css/app.min.css" != s("#app-style").attr("href") &&
                  s("#app-style").attr("href", "/template/assets/css/app.min.css"),
            ...
            ? (s("html").removeAttr("dir"),
              ...
              "/template//template/assets/css/bootstrap.min.css" !=
                  s("#bootstrap-style").attr("href") &&
                  s("#bootstrap-style").attr(
                      "href",
                      "/template//template/assets/css/bootstrap.min.css"
            ...
            ? (s("#light-mode-switch").prop("checked", !1),
              s("#dark-mode-switch").prop("checked", !1),
              s("#dark-rtl-mode-switch").prop("checked", !1),
              "/template/assets/css/bootstrap-rtl.min.css" !=
                  s("#bootstrap-style").attr("href") &&
                  s("#bootstrap-style").attr(
                      "href",
                      "/template/assets/css/bootstrap-rtl.min.css"
                  ),
              "/template/assets/css/app-rtl.min.css" != s("#app-style").attr("href") &&
                  s("#app-style").attr("href", "/template/assets/css/app-rtl.min.css"),
              s("html").attr("dir", "rtl"),
              s("html").attr("data-bs-theme", "light"),
