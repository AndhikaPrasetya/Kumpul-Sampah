...
<head>
    <meta charset="UTF-8">
    <title>Laporan Transaksi - BANK SAMPAH UNIT {{$user->user->name}}</title>
    <style>
        body { 
...
<body>
    <div class="header">
        ...
        <div style="margin-top: 15px;">
            <h3>LAPORAN TRANSAKSI {{ strtoupper($user->user->name) }}</h3>
            <div class="periode">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="total-row">
                ...
                <td>{{ number_format($data->sum(function($t) { return $t->details->sum('berat'); }), 0, ',', '.') }} KG</td>
