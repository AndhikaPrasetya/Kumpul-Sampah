    ...
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6 grid gap-6 text-center">
            <div class="grid gap-2">
                <h1 class="text-2xl font-bold text-green-700">Permintaan Tarik Tunai!</h1>
                <p class="text-gray-600">Permintaan Anda telah berhasil diajukan dan menunggu persetujuan Anda.</p>
            </div>
            
            <div class="grid gap-2 bg-yellow-50 p-4 rounded-lg">
                <h2 class="font-semibold text-yellow-700">Langkah Selanjutnya:</h2>
                <p class="text-gray-700">Silakan tinjau dan setujui permintaan ini sebelum diproses oleh admin.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2">
                <div class="bg-gray-50 p-3 rounded-lg text-center">
                    ...
                    <p class="text-sm text-gray-600 mt-2">Menunggu Persetujuan</p>
                </div>
                <div class="bg-gray-50 p-3 rounded-lg text-center">
                    ...
                    <p class="text-sm text-gray-600 mt-2">Diproses Admin</p>
                </div>
                <div class="bg-gray-50 p-3 rounded-lg text-center">
                    ...
                    <p class="text-sm text-gray-600 mt-2">Dana Diterima</p>
                </div>
            </div>
