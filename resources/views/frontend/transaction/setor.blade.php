...
@section('content')
    ...
    <div class="mb-20">
        <form id="createFormTransaction">
            ...
            <div class="mt-6 mb-6 p-2 text-center">
              
                <div>
                    <h2 class="text-xl font-bold">Setor Sampah, Dapatkan Manfaat</h2>
                    <p class="text-gray-600 text-sm">
                        Pilih kategori sampah dan masukkan beratnya untuk mulai setor.
                    </p>
                </div>
            </div>
                    ...
                    <div class="category-content" id="category-content-{{ $kategori->id }}">
                        @if (isset($groupedSampahs[$kategori->id]))
                            @foreach ($groupedSampahs[$kategori->id] as $sampah)
                                <div class="flex justify-between items-center p-3 border-b border-gray-100 sampah-item">
                                    <div>
