...
<body>
    ...
    <div id="appCapsule" style="max-width: 400px; margin:0 auto;">
        ...
        <div class="section p-3">
            <form method="POST" action="{{ route('register.bsu') }}">
                @csrf
                <div>
                    <div>
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label for="name">Nama BSU</label>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label for="email" :value="__('Email')">Email BSU</label>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="rt" name="rt" class="form-control shadow-sm"
                                    placeholder="name" required value="{{ old('RT') }}">
                                <i class="clear-input">
                                    <ion-icon name="close-circle" role="img" class="md hydrated"
                                        aria-label="close circle"></ion-icon>
                                </i>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="rw" name="rw" class="form-control shadow-sm"
                                    placeholder="name" required value="{{ old('rw') }}">
                                <i class="clear-input">
                                    <ion-icon name="close-circle" role="img" class="md hydrated"
                                        aria-label="close circle"></ion-icon>
                                </i>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label for="alamat">Alamat BSU</label>
                                <textarea name="alamat" class="form-control shadow-sm" id=""></textarea>
                                <i class="clear-input">
                                    <ion-icon name="close-circle" role="img" class="md hydrated"
                                        aria-label="close circle"></ion-icon>
                                </i>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <select class="form-control custom-select" name="kelurahan_id" id="kelurahan_id">
                                    <option value="" disabled selected>Pilih Kelurahan</option>
                                    @foreach ($kelurahans as $b)
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="password" id="password" name="password"
                                    class="form-control  shadow-sm" placeholder="Password" required>
                                <i class="clear-input">
                                    <ion-icon name="close-circle" role="img" class="md hydrated"
                                        aria-label="close circle"></ion-icon>
                                </i>
